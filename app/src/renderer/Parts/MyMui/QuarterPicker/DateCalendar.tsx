...
import {
  ...
  type DateCalendarDefaultizedProps,
...
import { type BaseDateValidationProps } from '@mui/x-date-pickers/internals/models/validation'
import {
...
function useDateCalendarDefaultizedProps<TDate extends PickerValidDate>(
  ...
  return {
    ...
    renderLoading:
      ...
      (() => <span data-testid="loading-progress">...</span>),
...
>(inProps: DateCalendarProps<TDate>, ref: React.Ref<HTMLDivElement>) {
  const utils = useUtils<TDate>()
  const id = useId()
